...
function Modal() {
    ...
    const uploadPost = async() => {
        ...
        // get the dowload url from fb storage and update the original post with image
                            ...
                            <div>
                                ...
                                <div className="mt-5 sm:mt-6">
                                    <button 
                                        ...
                                        py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-1
